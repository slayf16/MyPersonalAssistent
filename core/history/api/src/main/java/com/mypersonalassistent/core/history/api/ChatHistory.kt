...
interface HistoryRepository { fun observeSummaries(): Flow<List<ChatSummary>>; suspend fun read(id: String): ChatSnapshot?; suspend fun save(snapshot: ChatSnapshot): Boolean }
